...
def main():
    ...
    params = {'learning_rate': 0.04056956101904861, 'depth': 7, 'l2_leaf_reg': 7.459199917293563, 'border_count': 230, 'bagging_temperature': 0.44856780106647864, 'random_strength': 2.333989054467297, 'subsample': 0.7742421038427931, 'colsample_bylevel': 0.7364181387936571, 'iterations': 2390, 'min_data_in_leaf': 11, 'loss_function': 'Logloss', 'eval_metric': 'AUC', 'random_state': 42, 'thread_count': -1, 'verbose': False}
    ...
    submission_filename = f'submission_model_cat.csv'
